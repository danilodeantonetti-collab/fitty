        ...
        <div className="min-h-screen bg-background pb-32">
            <header className="sticky top-0 z-30 flex flex-col items-center justify-between border-b border-card-border bg-background/80 px-6 py-4 backdrop-blur-md gap-3">
                <div className="flex w-full items-center justify-between">
                    ...
                    <button onClick={handleFinish} className="rounded-full bg-accent px-4 py-1.5 text-xs font-black text-background uppercase tracking-wider">Finish</button>
                </div>
            ...
            <div className="fixed bottom-10 left-1/2 -translate-x-1/2 px-6 w-full max-w-sm">
                <button onClick={handleFinish} className="btn-primary w-full flex items-center justify-center gap-3 text-lg">
                    Session beenden
